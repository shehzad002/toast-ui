...
const StakeToast: React.FC<StakeProps> = ({}) => {
  ...
  const tokenBalance = useTokenBalance(contractAddresses.toast[56])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`TOAST Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
