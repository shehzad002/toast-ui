...
const FarmCards: React.FC = () => {
  ...
  const toastIndex = farms.findIndex(
    ({ tokenSymbol }) => tokenSymbol === 'TOAST',
  )

  const toastPrice =
    toastIndex >= 0 && stakedValue[toastIndex]
      ? stakedValue[toastIndex].tokenPriceInWeth
      : new BigNumber(0)

  const BLOCKS_PER_YEAR = new BigNumber(2336000)
  const TOAST_PER_BLOCK = new BigNumber(100)
...
const FarmCard: React.FC<FarmCardProps> = ({ farm }) => {
  ...
  }, [toast, lpTokenAddress, account, setHarvestable])
